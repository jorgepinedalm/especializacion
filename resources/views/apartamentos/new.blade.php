...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Nuevo Apartamento') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('apartamentos.save') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="area" type="number" class="form-control @error('area') is-invalid @enderror" name="area" value="{{ old('area') }}" required autocomplete="area" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="torre" type="number" class="form-control @error('torre') is-invalid @enderror" name="torre" value="{{ old('torre') }}" required autocomplete="torre" autofocus>
